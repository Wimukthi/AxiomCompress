...
switch (id) {
    ...
    case kCompressStream: return ToolbarIcon::compress_stream;
    case kDecompressStream: return ToolbarIcon::decompress_stream;
    case kUpdateArchive: return ToolbarIcon::update_archive;
    case kRepackArchive: return ToolbarIcon::repack;
    case kSplitArchive: return ToolbarIcon::split;
    case kJoinArchive: return ToolbarIcon::join;
    case kRepairArchive: return ToolbarIcon::repair;
    case kEditRecoveryRecord: return ToolbarIcon::recovery;
    ...
    case kGenerateSigningKey: return ToolbarIcon::key;
    case kSignArchive: return ToolbarIcon::sign;
