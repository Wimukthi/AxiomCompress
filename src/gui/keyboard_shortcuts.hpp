...
inline constexpr std::array<ShortcutCommandInfo, 48> kShortcutCommandCatalog{{
    ...
    {L"commands.add", L"Archive: Add to archive", L"Ctrl+N"},
    {L"commands.extract", L"Archive: Extract", L"Ctrl+E"},
    {L"commands.test", L"Archive: Test archive", L"Ctrl+T"},
    {L"commands.update", L"Archive: Update archive", L"Ctrl+U"},
    {L"commands.freshen", L"Archive: Freshen archive", L"Ctrl+Shift+U"},
    {L"commands.synchronize", L"Archive: Synchronize archive", L"Ctrl+Alt+U"},
    {L"commands.repack", L"Archive: Repack archive", L"Ctrl+Shift+R"},
    {L"commands.split", L"Archive: Split archive", L"Ctrl+Shift+S"},
    {L"commands.join", L"Archive: Join archive volumes", L"Ctrl+J"},
    ...
    {L"tools.edit_comment", L"Archive: Edit archive comment", L"Ctrl+M"},
    {L"tools.lock", L"Archive: Lock archive", L"Ctrl+Shift+L"},
    {L"tools.repair", L"Archive: Repair archive", L"Ctrl+Shift+P"},
    {L"tools.recovery_record", L"Archive: Edit recovery record", L"Ctrl+Shift+Y"},
    {L"tools.generate_key", L"Tools: Generate signing key", L"Ctrl+Shift+K"},
    {L"tools.sign_archive", L"Archive: Sign archive", L"Ctrl+Shift+G"},
    {L"tools.verify_signature", L"Archive: Verify signature", L"Ctrl+Shift+V"},
    {L"tools.create_sfx", L"Archive: Create self-extracting archive", L"Ctrl+Shift+X"},
    {L"navigation.back", L"View: Back", L"Alt+Left"},
    {L"navigation.forward", L"View: Forward", L"Alt+Right"},
    ...
    {L"options.remove_favorite", L"View: Remove favorite", L"Ctrl+Shift+D"},
    {L"options.settings", L"Tools: Settings", L"Ctrl+,"},
    {L"help.check_updates", L"Help: Check for updates", L"Ctrl+Alt+Shift+U"},
    {L"help.about", L"Help: About Axiom", L"F1"},
    {L"clipboard.copy_path", L"Edit: Copy path", L"Ctrl+Shift+C"},
    {L"clipboard.copy_crc32", L"Edit: Copy CRC-32", L"Ctrl+Alt+C"},
}};
