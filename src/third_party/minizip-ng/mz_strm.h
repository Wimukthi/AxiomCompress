...
typedef int32_t (*mzng_stream_open_cb)(void *stream, const char *path, int32_t mode);
typedef int32_t (*mzng_stream_is_open_cb)(void *stream);
typedef int32_t (*mzng_stream_read_cb)(void *stream, void *buf, int32_t size);
typedef int32_t (*mzng_stream_write_cb)(void *stream, const void *buf, int32_t size);
typedef int64_t (*mzng_stream_tell_cb)(void *stream);
typedef int32_t (*mzng_stream_seek_cb)(void *stream, int64_t offset, int32_t origin);
typedef int32_t (*mzng_stream_close_cb)(void *stream);
typedef int32_t (*mzng_stream_error_cb)(void *stream);
typedef void *(*mzng_stream_create_cb)(void);
typedef void (*mzng_stream_destroy_cb)(void **stream);

typedef int32_t (*mzng_stream_get_prop_int64_cb)(void *stream, int32_t prop, int64_t *value);
typedef int32_t (*mzng_stream_set_prop_int64_cb)(void *stream, int32_t prop, int64_t value);

typedef int32_t (*mzng_stream_find_cb)(void *stream, const void *find, int32_t find_size, int64_t max_seek,
                                     int64_t *position);

/***************************************************************************/

typedef struct mzng_stream_vtbl_s {
    mzng_stream_open_cb open;
    mzng_stream_is_open_cb is_open;
    mzng_stream_read_cb read;
    mzng_stream_write_cb write;
    mzng_stream_tell_cb tell;
    mzng_stream_seek_cb seek;
    mzng_stream_close_cb close;
    mzng_stream_error_cb error;
    mzng_stream_create_cb create;
    mzng_stream_destroy_cb destroy;

    mzng_stream_get_prop_int64_cb get_prop_int64;
    mzng_stream_set_prop_int64_cb set_prop_int64;
} mzng_stream_vtbl;

typedef struct mzng_stream_s {
    mzng_stream_vtbl *vtbl;
    struct mzng_stream_s *base;
} mzng_stream;
...
int32_t mzng_stream_raw_open(void *stream, const char *filename, int32_t mode);
